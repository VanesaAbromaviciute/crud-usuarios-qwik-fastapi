...
# Endpoint para obtener un usuario especifico por dni
...
@app.get("/users/minors/", response_description="Obtiene los usuarios menores de edad",  response_model=List[User])
...
@app.get("/users/adults/", response_description="Obtiene los usuarios mayores de edad",  response_model=List[User])
async def list_sdults():
    now = datetime.now()
    pipeline = [
        {
            "$project": {
